...
<div class="card">
    <div class="card-body">
        ...
        <h2 class="panel-title">Manage Who we are</h2>
          ...
          <input type="hidden" name="id" value="{{ $data->id }}">
            <div class="row">
              ...
              <div class="col-sm-7">
                <div class="form-group">
                  ...
                  <input type="text" name="sub_title_en" placeholder="Sub Title" value="{{ old('sub_title_en', $data->sub_title_en) }}"
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <textarea name="description_en" class="form-control @error('description_en') is-invalid @enderror" id="" cols="40" rows="3" placeholder="Description">{{ old('description_en', $data->description_en) }}</textarea>
            ...
            <div class="row">
              ...
              <div class="col-sm-7">
                <div class="form-group">
                  <label class="control-label">Sub Title <span class="text-danger">*</span></label>
                  <input type="text" name="sub_title_bn" placeholder="Sub Title" value="{{ old('sub_title_bn', $data->sub_title_bn) }}"
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  <label class="control-label">Description <span class="text-danger">*</span></label><br>
                  <textarea name="description_bn" class="form-control @error('description_bn') is-invalid @enderror" id="" cols="40" rows="3" placeholder="Description_bn">{{ old('description_bn', $data->description_bn) }}</textarea>
