...
<div class="card">
    <div class="card-body">
        ...
        <h2 class="panel-title">Create Legale Practice Area</h2>
            ...
            <div class="row">
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="" cols="40" rows="3" placeholder="Description">{{ old('description') }}</textarea>
                  @error('description')
