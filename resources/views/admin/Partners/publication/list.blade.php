        ...
        <div class="card-body">
          <section class="panel">
            <header class="panel-heading">
              <h2 class="panel-title">List of Publication</h2>
            </header>
            <div class="panel-body">
              ...
              <div class="row">
                  <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                    <a href="{{ route('partners.publication.create', request()->partner_id) }}" class="brn btn-success btn-sm">New Publication</a>
                  </div>
                </div>
                  ...
                  <tr class="@if(($key%2) == 0)gradeX @else gradeC @endif">
                    ...
                    <td width="200" class="p-1">{{ date('F d, Y h:i A', strtotime($val->created_at)) }}</td>
                      ...
                      <td class="center hidden-phone p-1" width="100">
                          <a href="{{ route('partners.publication.manage', ['partner_id'=>$val->partner_id,'id'=>$val->id]) }}" class="btn btn-sm btn-success"> <i
  ...
  <script>
    $(document).ready(function () {
      ...
      $(document).on('change', 'input[name="onoffswitch"]', function () {
        ...
        $.ajax({
          url: "{{ route('ajax.update.partners.publication.status') }}",
          method: "post",
          dataType: "html",
      ...
      $(document).on('click', '.yes-btn', function () {
        ...
        $.ajax({
          url: "{{ route('partners.publication.destroy',request()->partner_id) }}",
          method: "delete",
          dataType: "html",
          data: {id: pid},
          success: function (data) {
