        ...
        <div class="card-body">
          <section class="panel">
            <header class="panel-heading">
              <h2 class="panel-title">Create New Interview of <strong>{{ $partner->name }}</strong></h2>
            </header>
            <div class="panel-body">
              <div class="row">
                <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                  <a href="{{ route('partners.interview.list', request()->partner_id) }}" class="brn btn-success btn-sm">List of Membership</a>
                </div>
              </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select name="type" required class="form-control @error('type') is-invalid @enderror">
                                ...
                                @foreach(\App\Models\Interview::$typeArray as $types)
                                    <option value="{{ $types }}"
