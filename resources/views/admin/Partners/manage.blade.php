        ...
        <div class="card-body">
          <section class="panel">
            <header class="panel-heading">
              <h2 class="panel-title">Manage partners</h2>
            </header>
            <div class="panel-body">
              <div class="row">
                <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                  <a href="{{ route('partners.list') }}" class="brn btn-success btn-sm">partners list</a>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="name" placeholder="partners name" value="{{ old('name', $partners->name) }}"
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control summernote @error('description') is-invalid @enderror" rows="5">{{ old('description', $partners->description) }}</textarea>
                            @error('description')
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <textarea name="biography" class="form-control @error('biography') is-invalid @enderror" rows="5">{{ old('biography', $partners->biography) }}</textarea>
                      @error('biography')
