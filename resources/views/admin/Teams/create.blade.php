        ...
        <div class="card-body">
          <section class="panel">
            <header class="panel-heading">
              <h2 class="panel-title">Create New Team</h2>
            </header>
            <div class="panel-body">
              <div class="row">
                <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                  <a href="{{ route('team.list') }}" class="brn btn-success btn-sm">List of team</a>
                </div>
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="designation" placeholder="team designation" value="{{ old('designation') }}"
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="description" placeholder="team description" value="{{ old('description') }}"
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="file" name="image" required placeholder="team image" value="{{ old('image') }}"
                    ...
                    <div class="form-group">
                      ...
                      <select name="type" required class="form-control @error('type') is-invalid @enderror">
                        ...
                        @foreach(\App\Models\Team::$typeArray as $types)
                          <option value="{{ $types }}"
                                  @if(old('type') == $types) selected @endif>{{ ucfirst($types) }}</option>
                        @endforeach
                      </select>
                      @error('type')
