        ...
        <div class="card-body">
          <section class="panel">
            <header class="panel-heading">
              <h2 class="panel-title">Create New Clients</h2>
            </header>
            <div class="panel-body">
              <div class="row">
                <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                  <a href="{{ route('clients.list') }}" class="brn btn-success btn-sm">List of clients</a>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="title" placeholder="clients title" value="{{ old('title') }}"
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="designation" placeholder="clients designation" value="{{ old('designation') }}"
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="file" name="image" required placeholder="clients image" value="{{ old('image') }}"
